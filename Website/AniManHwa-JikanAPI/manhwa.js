...
async function fetchManhwa() {
    const url = `${apiUrl}/top/manga?type=manhwa&limit=25`; // Replace with appropriate endpoint for manhwa if available
...
function displayManhwa(manhwaList) {
    ...
    manhwaList.forEach(manhwa => {
        ...
        chapters.textContent = `Chapters: ${manhwa.chapters}`;
        chapters.classList.add('text-gray-600', 'text-sm', 'font-semibold', 'mb-2');
